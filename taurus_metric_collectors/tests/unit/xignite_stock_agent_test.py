...
@patch(
  "taurus_metric_collectors.xignite.xignite_stock_agent.metricDataBatchWrite",
  spec_set=xignite_stock_agent.metricDataBatchWrite)
@patch(
  "taurus_metric_collectors.xignite.xignite_stock_agent.urllib2",
  autospec=True)
class XigniteStockAgentTestCase(unittest.TestCase):

  @patch("taurus_metric_collectors.xignite.xignite_stock_agent.Pool",
    autospec=True)
  @patch("taurus_metric_collectors.xignite.xignite_stock_agent.time",
  autospec=True)
  ...
  @patch(
    "taurus_metric_collectors.xignite.xignite_stock_agent.getData",
    autospec=True)
  @patch(
    "taurus_metric_collectors.xignite.xignite_stock_agent._getLatestSample",
    autospec=True)
  @patch(
    "taurus_metric_collectors.xignite.xignite_stock_agent.collectorsdb",
    autospec=True)
  ...
  @patch(
    "taurus_metric_collectors.xignite.xignite_stock_agent.transmitMetricData",
    autospec=True)
  @patch(
    "taurus_metric_collectors.xignite.xignite_stock_agent._getLatestSample",
    autospec=True)
