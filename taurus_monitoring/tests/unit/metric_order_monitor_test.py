...
"""
Unittest of taurus_monitoring/metric_order/metric_order_monitor.py
"""
...
from taurus_monitoring.metric_order_monitor import metric_order_monitor as monitor
...
class MetricOrderMonitorTest(unittest.TestCase):
  ...
  @patch("nta.utils.error_reporting.sendMonitorErrorEmail")
  @patch("taurus_monitoring.taurus_monitor_utils.removeErrorFlag")
  @patch("taurus_monitoring.taurus_monitor_utils.addErrorFlag")
  @patch("taurus_monitoring.taurus_monitor_utils.containsErrorFlag")
