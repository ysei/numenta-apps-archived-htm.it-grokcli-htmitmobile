...
"""
Unittest of taurus_monitoring/models_monitor/taurus_models_monitor.py
"""
import unittest
...
import taurus_monitoring.models_monitor.taurus_models_monitor as modelsMonitor
...
class TaurusModelsMonitorTest(unittest.TestCase):
  ...
  @patch("taurus_monitoring.models_monitor.taurus_models_monitor."
         "removeErrorFlag")
  @patch("taurus_monitoring.models_monitor.taurus_models_monitor._reportIssue")
  @patch("requests.get")
