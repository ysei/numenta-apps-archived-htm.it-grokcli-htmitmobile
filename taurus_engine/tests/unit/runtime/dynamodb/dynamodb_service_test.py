...
"""
Unit tests for taurus_engine.runtime.dynamodb.dynamodb_runtime
"""
...
from taurus_engine.runtime.dynamodb.definitions.dynamodbdefinition import (
  DynamoDBDefinition)
from taurus_engine.runtime.dynamodb.definitions.\
...
class DynamoDBServiceTestCase(unittest.TestCase):
  ...
  @patch("taurus_engine.runtime.dynamodb.dynamodb_service.amqp."
  ...
  def testDynamoDBServiceRun(self, amqpClientClassMock, connectDynamoDB,
    ...
    amqpClientMock.declareExchange.assert_any_call(
      durable=True,
      exchangeType="fanout",
      exchange=taurus_engine.config.get("metric_streamer", "results_exchange_name"))

    amqpClientMock.declareExchange.assert_any_call(
      durable=True,
      exchangeType="topic",
      exchange=taurus_engine.config.get("non_metric_data", "exchange_name"))
